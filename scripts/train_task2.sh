...
python code/train_task2.py \
    ...
    --date $month \
    --load_state_path outputs/${owner_id}_checkpoints/task2/$data/epoch_2000_k_5_lr_0.0001_initalembed_yes_seed_$task1_seed/rglossfn_tweedie_activate_softplus_rgweight_100.0_lpweight_1.0_rankweight_0.1_conweight_0.05_gaussian_yes_crossattn_yes_bias_yes.pt \
    --load_node_embedding_path outputs/${owner_id}_node_embedding/task2/$data/train/epoch_2000_k_5_lr_0.0001_initalembed_yes_seed_$task1_seed/rglossfn_tweedie_activate_softplus_rgweight_100.0_lpweight_1.0_rankweight_0.1_conweight_0.05_gaussian_yes_crossattn_yes_bias_yes_node.pt \
    --fix_model yes \
    --con_weight 0.0 \
    --rank_weight 1.0 \
    --lp_weight $lp_weight \
